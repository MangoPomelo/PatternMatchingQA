...
class RelationshipPicker(Picker):
	def __init__(self):
		...
		super().addItemsFromFile("./RelationshipDict/cause.txt", self.cause_array)
		super().addItemsFromFile("./RelationshipDict/complication.txt", self.complication_array)
		super().addItemsFromFile("./RelationshipDict/cure.txt", self.cure_array)
		super().addItemsFromFile("./RelationshipDict/lasttime.txt", self.lasttime_array)
		super().addItemsFromFile("./RelationshipDict/deny.txt", self.deny_array)
		super().addItemsFromFile("./RelationshipDict/department.txt", self.department_array)
		super().addItemsFromFile("./RelationshipDict/drug.txt", self.drug_array)
		super().addItemsFromFile("./RelationshipDict/examination.txt", self.examination_array)
		super().addItemsFromFile("./RelationshipDict/food.txt", self.food_array)
		super().addItemsFromFile("./RelationshipDict/preventability.txt", self.preventability_array)
		super().addItemsFromFile("./RelationshipDict/susceptibles.txt", self.susceptibles_array)
		super().addItemsFromFile("./RelationshipDict/symptom.txt", self.symptom_array)
		super().addItemsFromFile("./RelationshipDict/treatment.txt", self.treatment_array)
		super().addItemsFromFile("./RelationshipDict/treatment_possibility.txt", self.treatment_possibility_array)
